import { Component, OnInit, EventEmitter, Output, AfterViewInit, ChangeDetectionStrategy, Input, OnChanges, SimpleChanges, OnDestroy } from '@angular/core';
...
export class QuejaListComponent implements OnInit, OnDestroy {
  ...
  private subMorePubs: Subscription;
  public styles: any;
